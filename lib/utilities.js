...
const kuvaCache = new Cache('https://10o.io/arbitrations.json', 300000, { logger, delayStart: true });
const sentientCache = new Cache('https://10o.io/anomaly.json', 300000, { logger, delayStart: true });
